...
{
	/* From FIPS-197 test vectors, repeated 10 times to ensure multiple blocks can be handled */
	const uint8_t ecb_key[16] = {
		0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F
	};
	uint8_t ecb_plaintext[] = {
	...
	uint8_t encrypted[sizeof(ecb_plaintext)] = {0};
	uint8_t decrypted[sizeof(ecb_plaintext)] = {0};
