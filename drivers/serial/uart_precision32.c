...
{
	const struct uart_precision32_config *config = dev->config->config_info;
...
static void uart_precision32_init_pins(struct device *dev)
{
	const struct uart_precision32_config *config = dev->config->config_info;
...
static int uart_precision32_init(struct device *dev)
{
	...
	uart_precision32_init_pins(dev);
...
#ifdef CONFIG_UART_PRECISION32_1

static const struct uart_precision32_config uart_precision32_1_config = {
	.base = UART1,
	.clock = cmuClock_UART1,
	.baud_rate = CONFIG_UART_PRECISION32_1_BAUD_RATE,
	.pin_rx = PIN_UART1_RXD,
	.pin_tx = PIN_UART1_TXD,
	.loc = CONFIG_UART_PRECISION32_1_GPIO_LOC,
};

static struct uart_precision32_data uart_precision32_1_data;

DEVICE_AND_API_INIT(uart_1, CONFIG_UART_PRECISION32_1_NAME,
		    &uart_precision32_init,
		    &uart_precision32_1_data, &uart_precision32_1_config,
		    PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEVICE,
		    &uart_precision32_driver_api);

#endif /* CONFIG_UART_PRECISION32_1 */
...
#ifdef CONFIG_USART_PRECISION32_1

static const struct uart_precision32_config usart_precision32_1_config = {
	.base = USART1,
	.clock = cmuClock_USART1,
	.baud_rate = CONFIG_USART_PRECISION32_1_BAUD_RATE,
	.pin_rx = PIN_USART1_RXD,
	.pin_tx = PIN_USART1_TXD,
	.loc = CONFIG_USART_PRECISION32_1_GPIO_LOC,
};

static struct uart_precision32_data usart_precision32_1_data;

DEVICE_AND_API_INIT(usart_1, CONFIG_USART_PRECISION32_1_NAME,
		    &uart_precision32_init,
		    &usart_precision32_1_data, &usart_precision32_1_config,
		    PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEVICE,
		    &uart_precision32_driver_api);
