...
//-----------------------------------------------------------------------------
//
// This file applies to the SIM3L1XX_PBSTD_A module
//
// Script: 0.61
// Version: 1
...
struct SI32_PBSTD_A_PBPGEN_Struct
{
   union
   {
      struct
      {
         ...
         volatile uint32_t PBPGEN_BITS: 12;
...
#define SI32_PBSTD_A_PBPGEN_PBPGEN_MASK  0x00000FFF
...
struct SI32_PBSTD_A_PBPGPHASE_Struct
{
   union
   {
      struct
      {
         ...
         volatile uint32_t PBPGPH0: 12;
                  uint32_t reserved0: 4;
         // Pulse Generator Phase 1
         volatile uint32_t PBPGPH1: 12;
...
#define SI32_PBSTD_A_PBPGPHASE_PBPGPH0_MASK  0x00000FFF
#define SI32_PBSTD_A_PBPGPHASE_PBPGPH0_SHIFT  0

#define SI32_PBSTD_A_PBPGPHASE_PBPGPH1_MASK  0x0FFF0000
...
typedef struct SI32_PBSTD_A_Struct
{
   ...
   uint32_t                                        reserved8;
   struct SI32_PBSTD_A_PBPGEN_Struct               PBPGEN         ; // Base Address + 0x80
   uint32_t                                        reserved9;
   uint32_t                                        reserved10;
   uint32_t                                        reserved11;
   struct SI32_PBSTD_A_PBPGPHASE_Struct            PBPGPHASE      ; // Base Address + 0x90
   uint32_t                                        reserved12;
   uint32_t                                        reserved13;
   uint32_t                                        reserved14;
} SI32_PBSTD_A_Type;
