...
struct SI32_DEVICEID_A_DEVICEID0_Struct
{
   union
   {
      struct
      {
         ...
         // Device ID 0
         volatile uint32_t DEVICEID0_BITS: 28;
      };
...
// Revision C.
#define SI32_DEVICEID_A_DEVICEID0_REVID_REVC_VALUE  2
#define SI32_DEVICEID_A_DEVICEID0_REVID_REVC_U32 \
   (SI32_DEVICEID_A_DEVICEID0_REVID_REVC_VALUE << SI32_DEVICEID_A_DEVICEID0_REVID_SHIFT)

#define SI32_DEVICEID_A_DEVICEID0_DEVICEID0_MASK  0xFFFFFFF0
#define SI32_DEVICEID_A_DEVICEID0_DEVICEID0_SHIFT  4
