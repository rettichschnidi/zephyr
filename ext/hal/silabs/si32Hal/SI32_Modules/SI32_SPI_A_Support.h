...
#ifndef __SI32_SPI_A_Support_Guard__
#define __SI32_SPI_A_Support_Guard__
...
typedef enum SI32_SPI_A_CLOCK_MODE_Enum
{
...
} SI32_SPI_A_CLOCK_MODE_Enum_Type;


//-----------------------------------------------------------------------------
// Define the LOCK Enum type

typedef enum SI32_SPI_A_FIFO_THRESHOLD_Enum
{
...
} SI32_SPI_A_FIFO_THRESHOLD_Enum_Type;
