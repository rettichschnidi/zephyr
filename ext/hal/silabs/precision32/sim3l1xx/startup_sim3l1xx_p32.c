...
void DMAERR_IRQHandler(void) ALIAS(IntDefaultHandler);
...
void TIMER2L_IRQHandler(void) ALIAS(IntDefaultHandler);
void TIMER2H_IRQHandler(void) ALIAS(IntDefaultHandler);
void ACCTR0_IRQHandler(void) ALIAS(IntDefaultHandler);
...
void DTM0_IRQHandler(void) ALIAS(IntDefaultHandler);
void DTM1_IRQHandler(void) ALIAS(IntDefaultHandler);
void DTM2_IRQHandler(void) ALIAS(IntDefaultHandler);
void ENCDEC0_IRQHandler(void) ALIAS(IntDefaultHandler);
void RTC0FAIL_IRQHandler(void) ALIAS(IntDefaultHandler);
void VDDLOW_IRQHandler(void) ALIAS(IntDefaultHandler);
void VCPFAIL_IRQHandler(void) ALIAS(IntDefaultHandler);
void DCDC_IRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
	...
	TIMER1L_IRQHandler,      // Timer 0 Low (16 bits only)
	TIMER1H_IRQHandler,      // Timer 0 High (16 or 32 bits)
	TIMER2L_IRQHandler,      // Timer 0 Low (16 bits only)
	TIMER2H_IRQHandler,      // Timer 0 High (16 or 32 bits)
	ACCTR0_IRQHandler,       // Advanced Capture Counter
	...
	DTM0_IRQHandler,         // Data Transfer Manager 0
	DTM1_IRQHandler,         // Data Transfer Manager 1
	DTM2_IRQHandler,         // Data Transfer Manager 2
	AES0_IRQHandler,         // AES 0
	ENCDEC0_IRQHandler,      // Encoder/Decoder
	RTC0FAIL_IRQHandler,     // RTC clock failure
	VDDLOW_IRQHandler,       // VDD low
	VCPFAIL_IRQHandler,      // VCP failure
	DCDC_IRQHandler,         // DCDC Converter
