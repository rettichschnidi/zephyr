...
//-----------------------------------------------------------------------------
//
// This file applies to the SIM3L1XX_SCONFIG_A module
//
// Script: 0.61
// Version: 1
...
#define SI32_SCONFIG_A_CONFIG_PM8DBGEN_MASK  0x00000002
#define SI32_SCONFIG_A_CONFIG_PM8DBGEN_SHIFT  1
// Disable debugging through Power Mode 8.
#define SI32_SCONFIG_A_CONFIG_PM8DBGEN_DISABLED_VALUE  0
#define SI32_SCONFIG_A_CONFIG_PM8DBGEN_DISABLED_U32 \
   (SI32_SCONFIG_A_CONFIG_PM8DBGEN_DISABLED_VALUE << SI32_SCONFIG_A_CONFIG_PM8DBGEN_SHIFT)
// Enable debugging through Power Mode 8. Power measurements cannot be made with
// debugging enabled.
#define SI32_SCONFIG_A_CONFIG_PM8DBGEN_ENABLED_VALUE  1
#define SI32_SCONFIG_A_CONFIG_PM8DBGEN_ENABLED_U32 \
   (SI32_SCONFIG_A_CONFIG_PM8DBGEN_ENABLED_VALUE << SI32_SCONFIG_A_CONFIG_PM8DBGEN_SHIFT)
