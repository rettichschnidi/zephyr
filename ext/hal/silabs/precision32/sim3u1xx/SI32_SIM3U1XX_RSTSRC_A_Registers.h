...
#define SI32_RSTSRC_A_RESETEN_USB0REN_MASK  0x00000200
#define SI32_RSTSRC_A_RESETEN_USB0REN_SHIFT  9
// Disable the USB0 reset event as a reset source.
#define SI32_RSTSRC_A_RESETEN_USB0REN_DISABLED_VALUE  0
#define SI32_RSTSRC_A_RESETEN_USB0REN_DISABLED_U32 \
   (SI32_RSTSRC_A_RESETEN_USB0REN_DISABLED_VALUE << SI32_RSTSRC_A_RESETEN_USB0REN_SHIFT)
// Enable the USB0 reset event as a reset source.
#define SI32_RSTSRC_A_RESETEN_USB0REN_ENABLED_VALUE  1
#define SI32_RSTSRC_A_RESETEN_USB0REN_ENABLED_U32 \
   (SI32_RSTSRC_A_RESETEN_USB0REN_ENABLED_VALUE << SI32_RSTSRC_A_RESETEN_USB0REN_SHIFT)
...
#define SI32_RSTSRC_A_RESETFLAG_USB0RF_MASK  0x00000200
#define SI32_RSTSRC_A_RESETFLAG_USB0RF_SHIFT  9
// A USB0 Reset event did not cause the last system reset.
#define SI32_RSTSRC_A_RESETFLAG_USB0RF_NOT_SET_VALUE  0
#define SI32_RSTSRC_A_RESETFLAG_USB0RF_NOT_SET_U32 \
   (SI32_RSTSRC_A_RESETFLAG_USB0RF_NOT_SET_VALUE << SI32_RSTSRC_A_RESETFLAG_USB0RF_SHIFT)
// A USB0 Reset event caused the last system reset.
#define SI32_RSTSRC_A_RESETFLAG_USB0RF_SET_VALUE  1
#define SI32_RSTSRC_A_RESETFLAG_USB0RF_SET_U32 \
   (SI32_RSTSRC_A_RESETFLAG_USB0RF_SET_VALUE << SI32_RSTSRC_A_RESETFLAG_USB0RF_SHIFT)
